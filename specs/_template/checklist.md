...
- [ ] Accessibility requirements are explicit (content descriptions, screen reader support)
- [ ] Observability requirements are explicit (logging, error surfacing, health checks)
- [ ] Platform/Android API level support is specified
